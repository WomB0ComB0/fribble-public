    ...
    <section className='flex-col w-full mx-auto flexCenter max-w-10xl paddings'>
        <section className="w-full gap-10 flexBetween max-lg:flex-col">
            <div className='flex flex-col items-start w-full'>
                ...
                <p className="max-w-lg mt-5 text-3xl font-extrabold md:text-5xl md:mt-10">I’m Software Engineer 👋</p>
            ...
            {user?.projects?.edges?.length > 0 ? (
              <Image src={user?.projects?.edges[0]?.node?.image} alt="project image" width={739} height={554} className='object-contain rounded-xl'/> ) : (
